...
module RefineryMemberPages
  class ConfigGenerator < Rails::Generators::Base
    ...
    def copy_files
      ...
      copy_file 'templates/config/members_only.nl.yml', 'config/locales/members_only.nl.yml'
      ...
      copy_file 'templates/config/admin_pages_controller_decorator.rb', 'app/decorators/controllers/refinery/admin/pages_controller_decorator.rb'
